...
public class PaymentOnCredit {
    ...
    public void checkFullCardInfo(String numberCard, String month, String year, String ownerName, String cvc) {
    ...
    public void checkDeclinedCardData() {
        ...
        btnSend.should(visible);
        notificationWaitSend.should(text("Отправляем запрос в Банк..."));
        notificationDeclined.should(text("Ошибка! Банк отказал в проведении операции."));
